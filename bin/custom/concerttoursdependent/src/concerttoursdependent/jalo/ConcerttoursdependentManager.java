...
/**
 * This is the extension manager of the Concerttoursdependent extension.
 */
public class ConcerttoursdependentManager extends GeneratedConcerttoursdependentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ConcerttoursdependentManager.class);
	 ...
	 */
	public static ConcerttoursdependentManager getInstance()
	{
		return (ConcerttoursdependentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ConcerttoursdependentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ConcerttoursdependentManager() // NOPMD 
	{
		LOG.debug("constructor of ConcerttoursdependentManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ConcerttoursdependentManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ConcerttoursdependentManager called, current tenant: {}", getTenant().getTenantID());
	}
