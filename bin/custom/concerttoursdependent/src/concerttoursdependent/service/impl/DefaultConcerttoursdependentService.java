 ...
 */
package concerttoursdependent.service.impl;
...
public class DefaultConcerttoursdependentService implements ConcerttoursdependentService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultConcerttoursdependentService.class);
	...
	{
		return DefaultConcerttoursdependentService.class.getResourceAsStream("/concerttoursdependent/sap-hybris-platform.png");
	}
